...
export default function ActionPlanPage() {
  ...
  return <AppLayout><PageHeader eyebrow="Seven-day cleanup queue" title="Operator cleanup queue" description="A practical sequence for closing the highest-leverage diligence gaps before the next investor meeting. Draft assignments for operator review."/>
